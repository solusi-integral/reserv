<?php include 'includes/core/document_head.php'?>
	<div id="pjax">
		<div id="wrapper" data-adminica-nav-top="2" data-adminica-nav-inner="2">
			...
			<div id="main_container" class="main_container container_16 clearfix">
				...
				<div class="flat_area grid_16">
					<h2>Beautifully formatted text content
						<div class="holder">
					...
					<div class="toggle_container">
						<div class="block">
							<div class="columns even">
								<div class="col_50">
									<div class="section">
										<p>Text boxes can have different amounts of content but still display columns with equal heights.</p>
									</div>
								</div>
								<div class="col_50">
									<div class="section">

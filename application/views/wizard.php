<?php include 'includes/core/document_head.php'?>
	<div id="pjax">
		<div id="wrapper" data-adminica-nav-top="3" data-adminica-nav-inner="3">
							...
							<div class="wizard_content">
								...
								<div id="step_1" class="step block" style="display:block;">
									...
									<div class="columns even clearfix">
										...
										<div class="col_50">
											<fieldset class="label_side bottom right">
												<label>Phone<span>with country code</span></label>
												<div>
										...
										<div class="col_50">
											<fieldset class="label_side top right">
												...
												<div>
													...
													<label for="required_2b" generated="true" class="error">This field is required.</label>
													<div class="required_tag"></div>
												</div>
											</fieldset>
										</div>
								...
								<div id="step_4" class="step block">
									...
									<fieldset class="label_side">
										...
										<div class="uniform inline clearfix">
											<input type="checkbox" name="required_4b" id="required_4b" class="required"/><label class="text">I agree with the terms and conditions</label>

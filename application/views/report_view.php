...
Debug information: <?php echo $date ?> | <?php echo $jump_date ?> | <?php echo $type ?> | <?php echo $runners ?> | <?php echo $number ?> | <?php echo $location ?> | <?php echo $results ?> | <?php echo $name ?> | <?php echo $comment ?> | <?php echo $counted; ?>
</body>
</html>